...
*NodeApi* | [**node_unlock_wallet_post**](docs/NodeApi.md#node_unlock_wallet_post) | **POST** /node/unlock_wallet | Unlocks a wallet for a given amount of seconds [async call]
