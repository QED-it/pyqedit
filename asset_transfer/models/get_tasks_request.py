...
class GetTasksRequest(object):
    ...
    def __init__(self, start_index=None, number_of_results=None, types=None, results=None, order='desc'):  # noqa: E501
    ...
    def order(self):
        ...
        Order of tasks to fetch (either ascending or descending); ordering is chronological where the time is set to when the task was created in this Node  # noqa: E501
