...
class Rule(object):
    ...
    @property
    def public_key(self):
        """Gets the public_key of this Rule.  # noqa: E501

        The public key of the Wallet that is being granted rights in this Rule  # noqa: E501

        :return: The public_key of this Rule.  # noqa: E501
        :rtype: str
        """
    ...
    def public_key(self, public_key):
        """Sets the public_key of this Rule.

        The public key of the Wallet that is being granted rights in this Rule  # noqa: E501

        :param public_key: The public_key of this Rule.  # noqa: E501
        :type: str
        """
    ...
    @property
    def is_admin(self):
        """Gets the is_admin of this Rule.  # noqa: E501

        Boolean signifying whether the Rule grants admin rights  # noqa: E501

        :return: The is_admin of this Rule.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_admin(self, is_admin):
        """Sets the is_admin of this Rule.

        Boolean signifying whether the Rule grants admin rights  # noqa: E501

        :param is_admin: The is_admin of this Rule.  # noqa: E501
        :type: bool
        """
        if is_admin is None:
    ...
    @property
    def namespace(self):
        """Gets the namespace of this Rule.  # noqa: E501
        ...
        :return: The namespace of this Rule.  # noqa: E501
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        """Sets the namespace of this Rule.

        A `Namespace` describes what Asset IDs can be issued in an Issuance Rule. It is a string in the same format as `AssetId`. Additionally, if it ends with a wildcard character `*`, then the namespace covers all asset IDs with the namespace as a prefix. Without a final wildcard, the namespace covers exactly one asset ID. Example: The namespace `currencies.dollar` covers only this exact asset type, while `currencies.*` covers all asset types that start with `currencies.`.   # noqa: E501

        :param namespace: The namespace of this Rule.  # noqa: E501
        :type: str
        """
    ...
    def can_issue_confidentially(self):
        """Gets the can_issue_confidentially of this Rule.  # noqa: E501
        ...
        :return: The can_issue_confidentially of this Rule.  # noqa: E501
        :rtype: bool
        """
    ...
    def can_issue_confidentially(self, can_issue_confidentially):
        """Sets the can_issue_confidentially of this Rule.

        Boolean signifying whether the Rule grants confidentialy issuance rights; if true, then both public and confidential issuance right are granted; if false, then only public issuance rights are granted  # noqa: E501

        :param can_issue_confidentially: The can_issue_confidentially of this Rule.  # noqa: E501
        :type: bool
        """
        if can_issue_confidentially is None:
            raise ValueError("Invalid value for `can_issue_confidentially`, must not be `None`")  # noqa: E501
