...
class NodeApi(object):
    ...
    def node_unlock_wallet_post(self, unlock_wallet_request, **kwargs):  # noqa: E501
        """Unlocks a wallet for a given amount of seconds [async call]  # noqa: E501

        Causes a specified Wallet's secret key to be stored in-memory for a specified amount of time in order to increase transactional latency. Should only be used in cases where latency is highly sensitive.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.node_unlock_wallet_post(unlock_wallet_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UnlockWalletRequest unlock_wallet_request: (required)
        :return: AsyncTaskCreatedResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.node_unlock_wallet_post_with_http_info(unlock_wallet_request, **kwargs)  # noqa: E501
        else:
            (data) = self.node_unlock_wallet_post_with_http_info(unlock_wallet_request, **kwargs)  # noqa: E501
            return data

    def node_unlock_wallet_post_with_http_info(self, unlock_wallet_request, **kwargs):  # noqa: E501
        """Unlocks a wallet for a given amount of seconds [async call]  # noqa: E501

        Causes a specified Wallet's secret key to be stored in-memory for a specified amount of time in order to increase transactional latency. Should only be used in cases where latency is highly sensitive.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.node_unlock_wallet_post_with_http_info(unlock_wallet_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['unlock_wallet_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method node_unlock_wallet_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'unlock_wallet_request' is set
        if ('unlock_wallet_request' not in local_var_params or
                local_var_params['unlock_wallet_request'] is None):
            raise ValueError("Missing the required parameter `unlock_wallet_request` when calling `node_unlock_wallet_post`")  # noqa: E501
        ...
        body_params = None
        if 'unlock_wallet_request' in local_var_params:
            body_params = local_var_params['unlock_wallet_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
